...
- Viewer seed: `viewer@acme.com` / `admin123`.
...
cd frontend && npx playwright test   # 20 tests; global-setup migrates + seeds

make validate
```

Seed logins: `acme` / `admin@acme.com` / `admin123`; `viewer@acme.com` / `admin123`.
